...
= WP2Social Auto Publish 2.4.1 =
* Added fix to prevent duplicate posting
* Compatibility with facebook API V 15.0 added
* Corrected Facebook post view link generation
